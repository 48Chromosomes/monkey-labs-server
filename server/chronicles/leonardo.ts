...
export default async function imageGenerationHandler(
	...
	try {
		...
		const response = await sdk.createGeneration({
			prompt: `Jason Voorhees, hockey mask, ${description}, Halloween, Friday the 13th, fantasy concept art, cinematic, ultra detailed, highly detailed face, 8k resolution`,
