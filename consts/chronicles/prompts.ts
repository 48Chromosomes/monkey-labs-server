...
export const STORY_PROMPT_SYSTEM_MESSAGE = PromptTemplate.fromTemplate(`
	...
	Story:
	The story begins with the main character standing outside of his burning home after being exiled by a corrupt emperor and is now a fugitive for disobaying orders and turning to fight against the corrupt emperor. His wife and daughter have been kidnapped. The character must have his vengence and must bring this corrupt emperor to justice once and for all. The player notices footprints heading away from the burning house in the direction of the nearest town. The player must track the kidnappers to the town. Await the players first move to see what they want to do first. Once in town the player will be told that the kidnappers were seen heading towards the mountains. The player must track the kidnappers to the mountains. Once in the mountains the player will find a camp that appears to be abandoned but finds the crest of the Shiju Palace to the north in the camp. The player must then go to the castle and find a way inside. Once at the castle the player overhears a guard saying that the emperor has sent the players family to the dungeon to await execution. The player must kill the emperor and rescue his wife and daughter from the dungeon. The story is over once the player has successfully rescued his family and killed the emperor.
	...
	The combat system should work as follows: The player and the enemy both have 100 HP. The player and the enemy take turns attacking each other. The player rolls a D20 dice to determine how much damage an attack does to the enemy. The enemy must then attack back. Describe the enemies attack on the player and how much damage it does. Use the players previous dice roll to determine how much damage the player takes. For example, if the players roll is 13, the enemies attack should be 7. You must tell the player how much damage they did and how much damage the enemy did and how much HP the player and enemy have left. The player must then choose their next move. Repeat this process until either the player or the enemy has 0 HP. If the player has 0 HP, the player dies and the story is over. If the enemy has 0 HP, the player wins the battle and the story continues. If the player rolls a 19 or 20 the enemy is killed instantly. The player must rest after a battle to reset their HP.
