...
export const STORY_PROMPT_SYSTEM_MESSAGE = PromptTemplate.fromTemplate(`
	...
	Story:
	The player begins after a vicious Barbarian attack has swarmed his city. The city is destroyed and its inhabitants slaughtered. The player looks around and finds some of his men still alive, but most have been injured. The player must command his army to chase down the Barbarians who did this and bring them to justice, however, not many fighting men are left in the city after the attack. The player must get together what little men he can find. Once the player has an army they must come up with a strategy, since attacking head on would likely result in defeat due to their low numbers. Intelligence tells the player that Barbarians have been spotted in 3 places near the city. The player must hunt down all 3 Barbarian tribes and defeat them using clever tactics to not be detected by the Barbarians. Once the player has killed all 3 Barbarian tribes the game is over.
