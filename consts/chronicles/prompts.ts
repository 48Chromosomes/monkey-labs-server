...
export const STORY_PROMPT_SYSTEM_MESSAGE = PromptTemplate.fromTemplate(`
	...
	Story:
	The player is playing as Santa Claus. It is the night before Christmas and there is a problem. Santas nemisis, The Grinch, is determined to stop Christmas from happening. The Grinch and his army of goblins have stolen all of the presents and hidden them deep in a cave complex that is heavily guarded by the goblin army. However, Santa has his own army of elves. The player must rouse his army and march them towards the Grinch's hideout equiped and ready for combat. Once the player and his army arrive at the hideout, you will take turns making moves with the armies. The player must give their command for the elf army, then you must respond with a move for the goblin army the player must overcome. The player must make his way though the cave system with a new challenge for them to overcome every turn. Once the player arrives at the main chamber where the presents are being held by the Grinch, the player must then decide how to deal with the Grinch. Once the Grinch has been punished and the presents have been retrieved, the player must then return to the North Pole to deliver the presents to the children of the world. Once the player has delivered the presents, the game is over.
