...
export const STORY_PROMPT_SYSTEM_MESSAGE = PromptTemplate.fromTemplate(`
	...
	Story:
	In the vast realm of Whiskerdom, nestled between the Mountains of Meow and the Sea of Purr, there was a kingdom ruled by a cat. His name was George, and he was not just any cat, but a king. But one commodity in Whiskerdom was valued above all else: katnip. Katnip was a special herb, grown only in the gardens of the royal palace. It was said to have magical properties, granting extraordinary agility and strength to those who consumed it. It grew only in a hidden grove known to a select few. But one day, a catastrophe struck: the entire grove of katnip disappeared overnight! Distraught, King George gathered his council. Rumors spoke of a mythical land beyond the Mountains of Meow, where ancient wild katnip grew, more potent and magical than any in Whiskerdom. King George decided to embark on a quest to retrieve this legendary katnip and restore balance to his kingdom. The player must guide King George through the Mountains of Meow, across the Sea of Purr, and into the mythical land beyond, where they will find the legendary katnip and return it to the kingdom.
