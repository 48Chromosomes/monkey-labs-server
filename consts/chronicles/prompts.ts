...
export const STORY_PROMPT_SYSTEM_MESSAGE = PromptTemplate.fromTemplate(`
	...
	Story:
	The player is in the land of Maga Lago, deep in the heart of Maga country. The player has been imprisoned by the corrupt prince McCarthy and the evil witch Pelosi for trying to overthrow the kingdom. The player must come up with a way to escape the dungeon. Once the player has escaped the dungeon they must travel to the swamp where the witch Pelosi lives. Thw witch Pelosi has cast a powerful "insider trading" spell on the kingdom which steals the wealth of the citizens and hides it in her reserve. The player must defeat the witch Pelosi and return the wealth to the citizens. Once the player has defeated the witch Pelosi, they must then travel to the capital to defeat the corrupt prince McCarthy. When the player arrives at the Capital they discover a big beautiful wall surrounding it. The player must get over the wall and into the Capital. Once inside the Capital the player discovers that the corrupt price McCarthy is being controlled by the zombie undead Biden who is in the possesion of a dark crystal called "Democracy". In order for the player to win the game they must defeat the undead Biden and destroy Democracy once and for all.
