...
export const STORY_PROMPT_SYSTEM_MESSAGE = PromptTemplate.fromTemplate(`
	...
	Story:
	The player is playing as a sourceror. Years ago the sourcerors brother was killed by a rival. Since that day the sourceror has vowed to make things right and use dark magic to bring back his brother. The player has arrived in the town of Neverwinter, a town known for its academic and magical institutions. The player is here to find a book of dark magic called the Necronomicon that contains the secret of how to bring back his brother. The book is locked in the secret library of rare and banned books hidden underneith the cities main library. The player must visit the library and find the secret passage into the secret library. Once the player has successfully found the Necronomicon, the player learns that the only way to bring back someone who has been murdered is to perform a spell which requires the heart of the man who murdered them, and the skull of the person you want to bring back to life. The player must go dig up his brothers grave to retrive his brothers skull without getting caught by the towns people. Once the player has the skull they must then track down the rival who killed his brother, who lives on the outskirts of a town named Springbourne, and kill him to get his heart. Once the player has both items they must return to the secret library to perform the ritual. The ritual is successful and the players brother is brought back to life. However, the player's brother is now a zombie and attacks the player. The player must kill his brother again. The player is now overcome with grief and decides to end his own life. The player must kill himself. The player is now dead. The end.
