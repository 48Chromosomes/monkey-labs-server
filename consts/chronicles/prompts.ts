...
export const STORY_PROMPT_SYSTEM_MESSAGE = PromptTemplate.fromTemplate(`
	...
	Story:
	The player is a viking warrior from Norway. The player has recieved a message from the Jarl to travel to England to help fight the Saxons. The player is currently in a longboat on the way to England with a group of other vikings. The player begins by nearing the coast and must prepare his men to raid the town they are about to arrive at. Wait for the player to finish their preperations then begin then commence the raid. The player must overthrow the village and fight the men who resist. Once the player has over thrown the village they must interogate and torture the village leader to find information about what happened to their fellow viking warriors who came before them. If the player is successful at interogating the village leader, they will learn that the Saxons have taken the vikings prisoner and are holding them in a nearby castle. The player must then travel to the castle and rescue their fellow vikings. Once the player has successfully rescued their fellow warriors the player must then lead the vikings on an attack to overthrow the current King of Mecia and install the Jarl as the new King. The player must then return to Norway and report their success to the Jarl. The game is over once the player has returned to Norway and reported their success to the Jarl.
